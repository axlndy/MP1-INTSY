...
void initializeDestinations(desType *destinations) {
  ...
  destinations[0].row = -1;
  destinations[0].col = -1;
  ...
  destinations[1].row = -1;
  destinations[1].col = -1;
  ...
  destinations[2].row = -1;
  destinations[2].col = -1;
  ...
  destinations[3].row = -1;
  destinations[3].col = -1;
  ...
  destinations[4].row = -1;
  destinations[4].col = -1;
  ...
  destinations[5].row = -1;
  destinations[5].col = -1;
